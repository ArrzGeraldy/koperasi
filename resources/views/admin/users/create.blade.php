        ...
        <main class="flex-1 overflow-y-auto p-6">
          ...
          <div class="bg-white rounded-lg shadow p-6 max-w-4xl">
            <form action="{{ route('admin.users.store') }}" method="POST">
              ...
              <!-- Dana Simpanan -->
              <div class="mb-6">
                <label for="dana_simpanan" class="block text-sm font-medium text-gray-700 mb-2">Dana Simpanan Awal <span class="text-red-500">*</span></label>
                <div class="relative">
                  <span class="absolute left-4 top-2.5 text-gray-500 font-medium">Rp</span>
                  <input type="number" name="dana_simpanan" id="dana_simpanan" value="{{ old('dana_simpanan', 0) }}" placeholder="0" required min="0" step="1000"
                ...
                @error('dana_simpanan')
                  <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
                <p class="text-xs text-gray-500 mt-1">Limit pinjaman akan otomatis dihitung (3x dana simpanan)</p>
              </div>
